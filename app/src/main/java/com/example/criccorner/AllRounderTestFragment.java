...
public class AllRounderTestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_all_rounder_test, container, false);
    ...
    public void readFirebaseRealtimeDatabase() {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                List<TestAllRounder> playerList = new ArrayList<>();

                for (DataSnapshot singleSnapshot : dataSnapshot.getChildren()) {
                    TestAllRounder home = singleSnapshot.getValue(TestAllRounder.class);
                    playerList.add(home);
