...
public class BowlerOdiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bowler_odi, container, false);
    ...
    public void readFirebaseRealtimeDatabase() {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                List<OdiBowler> playerList = new ArrayList<>();

                for (DataSnapshot singleSnapshot : dataSnapshot.getChildren()) {
                    OdiBowler home = singleSnapshot.getValue(OdiBowler.class);
                    playerList.add(home);
